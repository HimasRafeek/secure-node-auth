...
- 📖 [Accessing User-Specific Data](docs.html?doc=USER_DATA_ACCESS.md) - Complete guide on protecting routes and accessing user's posts, orders, etc.
- 🔄 [Authentication Flow Diagram](docs.html?doc=FLOW_DIAGRAM.md) - Visual guide showing how authentication works
- ⚡ [Quick Reference](docs.html?doc=QUICK_REFERENCE_USER_DATA.md) - Common patterns cheat sheet
- 🚀 [Getting Started](docs.html?doc=GETTING_STARTED.md) - Step-by-step setup guide
- 🔒 [Security Documentation](docs.html?doc=SECURITY.md) - **Comprehensive security features and best practices**
- 📋 [Security Audit Report](docs.html?doc=SECURITY_AUDIT_REPORT.md) - **Expert-level security audit results (49 issues resolved)**
